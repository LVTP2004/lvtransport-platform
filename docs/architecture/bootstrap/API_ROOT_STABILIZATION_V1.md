...
Stabilize apps/api before continuing shared contract adoption.

## Rule

Do not migrate shared contracts into API while unrelated TypeScript failures remain active.
...
```txt
     42 modules/persistence
     26 modules/payments
      2 modules/bookings
      1 websocket/socket.server.ts(49,92): error TS2554: Expected 1 arguments, but got 2.
      1 websocket/socket.server.ts(44,9): error TS2451: Cannot redeclare block-scoped variable 'broadcast'.
      1 websocket/socket.server.ts(31,9): error TS2451: Cannot redeclare block-scoped variable 'broadcast'.
      1 tracking/tracking.service.ts(45,3): error TS2393: Duplicate function implementation.
      1 tracking/tracking.service.ts(20,3): error TS2393: Duplicate function implementation.
      1 server.ts(13,9): error TS2451: Cannot redeclare block-scoped variable 'start'.
      1 server.ts(12,9): error TS2451: Cannot redeclare block-scoped variable 'start'.
      1 routes/v1
      1 persistence/repository-contracts.ts(30,40): error TS2304: Cannot find name 'RideStatus'.
      1 persistence/repository-contracts.ts(13,11): error TS2304: Cannot find name 'RideStatus'.
      1 operational-memory/cli.ts(84,99): error TS2339: Property 'outputFile' does not exist on type 'MemoryIndex'.
      1 operational-memory/cli.ts(81,7): error TS2300: Duplicate identifier 'main'.
      1 operational-memory/cli.ts(72,10): error TS2300: Duplicate identifier 'buildOperationalMemoryIndex'.
      1 operational-memory/cli.ts(53,16): error TS2300: Duplicate identifier 'main'.
      1 operational-memory/cli.ts(1,10): error TS2300: Duplicate identifier 'buildOperationalMemoryIndex'.
      1 dispatch/dispatch.service.ts(2,10): error TS2305: Module '"..
      1 bookings/booking.service.ts(85,13): error TS2339: Property 'driverId' does not exist on type 'BookingRecord'.
      1 bookings/booking.service.ts(78,31): error TS2345: Argument of type 'import("
      1 bookings/booking.service.ts(75,27): error TS2345: Argument of type 'import("
      1 bookings/booking.service.ts(72,5): error TS2322: Type '"pending" | "assigned" | "completed" | "cancelled" | "failed" | "driver_arriving" | "passenger_onboard" | "confirmed" | "quoted"' is not assignable to type 'BookingLifecycle'.
      1 bookings/booking.service.ts(65,37): error TS2345: Argument of type 'BookingLifecycle' is not assignable to parameter of type '"pending" | "assigned" | "completed" | "cancelled" | "failed" | "driver_arriving" | "passenger_onboard" | "confirmed" | "quoted"'.
      1 bookings/booking.service.ts(40,31): error TS2345: Argument of type 'import("
      1 bookings/booking.service.ts(33,7): error TS2322: Type 'import("
      1 bookings/booking.service.ts(31,7): error TS2322: Type '"pending"' is not assignable to type 'BookingLifecycle'.
      1 bookings/booking-notification-flow.service.ts(76,72): error TS2554: Expected 0-1 arguments, but got 2.
```
...
API shared contract migration is BLOCKED until API build errors are reduced below 10.
