...
function FounderCockpitRoute() {
    ...
    if (!COCKPIT_ROUTES.has(path)) {
        return _jsx("main", { className: "min-h-screen bg-lvtp-obsidian p-6 text-zinc-100", children: _jsxs("div", { className: "mx-auto max-w-3xl rounded-2xl border border-amber-400/20 bg-black/40 p-5", children: [_jsx("p", { className: "text-xs uppercase tracking-[0.2em] text-zinc-400", children: "Founder Operational Cockpit" }), _jsx("h1", { className: "mt-2 text-xl font-semibold text-amber-200", children: "Route not mapped" }), _jsxs("p", { className: "mt-3 text-sm text-zinc-300", children: ["Open one of the cockpit routes: ", _jsx("code", { children: "/founder" }), ", ", _jsx("code", { children: "/founder/cockpit" }), ", ", _jsx("code", { children: "/control-tower" }), ", ", _jsx("code", { children: "/operations" }), ", ", _jsx("code", { children: "/control" }), ", ", _jsx("code", { children: "/cockpit" }), ", or ", _jsx("code", { children: "/admin/founder" }), "."] })] }) });
    }
    return _jsx(App, {});
}
const pwa = initPwa();
