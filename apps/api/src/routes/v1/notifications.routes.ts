...
notificationRoutes.get('/notifications/active', (req, res) => res.json(notificationService.listActiveOperationalAlerts(req.query.audience as never)));
notificationRoutes.get('/notifications/stale', (_req, res) => res.json(notificationService.detectStaleOperations()));
