...
router.get('/admin/billing-lifecycle', (req, res) => res.json(paymentArchitectureService.getAdminBillingLifecycle(req.query.bookingId as string | undefined)));
router.post('/business/accounts', (req, res) => res.status(201).json(paymentArchitectureService.registerBusinessAccount(req.body)));
