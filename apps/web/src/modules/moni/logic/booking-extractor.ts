import type { MoniBookingFields } from '../types/moni.types';
...
const prompts: Record<string, Record<keyof MoniBookingFields, string>> = {
  nl: {
...
export const nextMissingPrompt = (lang: 'nl' | 'en' | 'es', data: MoniBookingFields): string | null => {
