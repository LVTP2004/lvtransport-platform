...
export function App() {
  ...
  const submitBooking = async () => {
    ...
    inFlightKeyRef.current = dedupeKey; setRequestKey(dedupeKey); setError(''); setLoading(true); appendEvent('submit_started', { dedupeKey, step });
    try {
