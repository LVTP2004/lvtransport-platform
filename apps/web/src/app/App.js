...
export function App() {
    ...
    return _jsxs("div", { className: 'min-h-screen bg-lv-black px-3 py-4 text-white sm:px-6 lg:px-8', children: [_jsxs("div", { className: 'mx-auto w-full max-w-6xl', children: [_jsxs("section", { className: 'mb-4 grid gap-2 md:grid-cols-2', children: [_jsxs("div", { className: 'rounded-2xl border border-white/10 bg-black/30 px-3 py-2 text-xs text-lv-mist', children: ["Connectivity: ", _jsx("span", { className: isOnline ? 'text-emerald-300' : 'text-amber-300', children: isOnline ? 'Online realtime' : 'Offline-safe mode' })] }), _jsxs("div", { className: 'rounded-2xl border border-white/10 bg-black/30 px-3 py-2 text-xs text-lv-mist', children: ["PWA install: ", _jsx("span", { className: 'text-lv-champagne', children: installReady ? 'Ready' : 'Pending browser prompt' })] })] }), _jsxs("section", { className: 'grid gap-4 lg:grid-cols-[1.2fr_0.8fr]', children: [_jsx("div", { className: 'glass-panel rounded-3xl p-4 sm:p-6', children: confirmation ? _jsxs("div", { className: 'space-y-4', children: [_jsx("p", { className: 'text-xs uppercase tracking-[0.2em] text-lv-champagne', children: "Booking confirmed" }), _jsxs("h2", { className: 'text-2xl font-semibold', children: ["Reference: ", confirmation.referenceCode] }), _jsxs("p", { className: 'text-lv-mist', children: ["Status: ", confirmation.status] }), _jsx("p", { className: 'text-xs text-lv-mist', children: "Keep this booking code for support and status checks." }), _jsx(Button, { className: 'shadow-gold-md', onClick: resetDraft, children: "Create another booking" })] }) : _jsxs(_Fragment, { children: [_jsxs("div", { className: 'mb-4 flex items-center justify-between', children: [_jsxs("p", { className: 'text-sm text-lv-mist', children: ["Step ", step, " of 3"] }), _jsx("p", { className: 'text-xs text-lv-mist', children: "All fields are required for dispatch readiness." })] }), step === 1 && _jsxs("div", { className: 'space-y-4', children: [_jsxs("label", { className: 'field-wrap', children: [_jsx("span", { children: "Pickup" }), _jsx("input", { value: pickup, onChange: (e) => setPickup(e.target.value) })] }), _jsxs("label", { className: 'field-wrap', children: [_jsx("span", { children: "Destination" }), _jsx("input", { value: destination, onChange: (e) => setDestination(e.target.value) })] }), _jsxs("label", { className: 'field-wrap', children: [_jsx("span", { children: "Date & time" }), _jsx("input", { type: 'datetime-local', value: dateTime, onChange: (e) => setDateTime(e.target.value) })] })] }), step === 2 && _jsxs("div", { className: 'space-y-4', children: [_jsxs("div", { className: 'field-wrap', children: [_jsx("span", { children: "Passengers" }), _jsxs("div", { className: 'mt-2 flex items-center justify-between rounded-2xl border border-lv-gold/20 bg-white/5 px-4 py-3', children: [_jsx("button", { className: 'control-btn', onClick: () => setPassengers((v) => Math.max(1, v - 1)), children: "\u2212" }), _jsx("strong", { className: 'text-lg', children: passengers }), _jsx("button", { className: 'control-btn', onClick: () => setPassengers((v) => Math.min(12, v + 1)), children: "+" })] })] }), _jsx("div", { className: 'grid gap-2', children: vehicles.map((item) => _jsx("button", { onClick: () => setVehicle(item), className: `vehicle-card ${vehicle.name === item.name ? 'vehicle-card--active' : ''}`, children: _jsxs("div", { children: [_jsx("p", { className: 'font-medium', children: item.name }), _jsxs("p", { className: 'text-xs text-lv-mist', children: ["ETA ", item.eta, " \u2022 up to ", item.seats, " passengers"] })] }) }, item.name)) })] }), step === 3 && _jsxs("div", { className: 'space-y-3', children: [_jsx("button", { className: `toggle-card ${airportTransfer ? 'toggle-card--active' : ''}`, onClick: () => setAirportTransfer((v) => !v), children: "Airport transfer" }), _jsx("button", { className: `toggle-card ${businessVip ? 'toggle-card--active' : ''}`, onClick: () => setBusinessVip((v) => !v), children: "Business / VIP" })] }), info && _jsx("p", { className: 'mt-3 text-sm text-lv-champagne', children: info }), error && _jsx("p", { className: 'mt-3 text-sm text-rose-300', children: error }), _jsxs("div", { className: 'mt-5 flex gap-2', children: [_jsx(Button, { variant: 'secondary', className: 'flex-1', disabled: loading, onClick: () => setStep((v) => (v > 1 ? (v - 1) : v)), children: "Back" }), step < 3 ? _jsx(Button, { className: 'flex-1', disabled: loading, onClick: () => setStep((v) => (v < 3 ? (v + 1) : v)), children: "Continue" }) : _jsx(Button, { className: 'flex-1 shadow-gold-md', onClick: submitBooking, disabled: loading || !pickup || !destination || !dateTime || !isOnline, children: loading ? 'Submitting...' : 'Confirm booking' })] })] }) }), _jsxs("aside", { className: 'space-y-4', children: [_jsxs("article", { className: 'glass-panel rounded-3xl p-4', children: [_jsx("p", { className: 'text-xs uppercase tracking-[0.2em] text-lv-champagne', children: "Price estimate" }), _jsxs("p", { className: 'mt-2 text-3xl font-semibold', children: ["$", baseFare] })] }), _jsxs("article", { className: 'glass-panel rounded-3xl p-4', children: [_jsx("p", { className: 'text-xs uppercase tracking-[0.2em] text-lv-champagne', children: "Booking summary" }), _jsxs("ul", { className: 'mt-3 space-y-2 text-sm', children: [_jsxs("li", { children: ["Pickup: ", pickup || 'Not set'] }), _jsxs("li", { children: ["Destination: ", destination || 'Not set'] }), _jsxs("li", { children: ["Schedule: ", formatDateTime(dateTime)] })] })] })] })] })] }), _jsx(MoniAssistant, {})] });
}
